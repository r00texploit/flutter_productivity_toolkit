...
class PlatformIssueDetector {
    ...
    if (errorMessage.contains('app transport security') ||
      ...
      issues.add(
        const PlatformIssue(
          ...
          description:
              'HTTP requests are blocked by iOS App Transport Security',
      ...
      if (errorMessage.contains('cors') ||
        ...
        issues.add(
          const PlatformIssue(
            ...
            description:
                'Cross-Origin Resource Sharing (CORS) policy violation',
  ...
  static List<PlatformRecommendation> _getIOSRecommendations() => [
        const PlatformRecommendation(
          ...
          implementation:
              'Enable in Xcode build settings: ENABLE_BITCODE = YES',
        ),
        const PlatformRecommendation(
          platform: TargetPlatform.iOS,
          category: 'Security',
